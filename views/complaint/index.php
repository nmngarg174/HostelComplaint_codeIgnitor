<body class="landing">
    ...
    <section id="banner">
        <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();" style="position:absolute; top: 0; z-index: 20000; color: wheat;">
            Your Login credentials have been emailed to the registered email.
        ...
        <p><font color="blue">
        <!-- Main Notice -->
        Those who have not received registration email kindly contact the caretaker and<br> provide necessary details for completion of process. 
        </font></p>
        <ul class="actions">
